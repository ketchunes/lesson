<template>
  <div class="py-10 px-10 md:px-16 2xl:px-28">
  ...
  const cards = [
    {
      ...
      text: "Simple and secure control of your organization’s financial and legal transactions. Send customized invoices ",
    },
    {
      img: "img/doc-2.png",
