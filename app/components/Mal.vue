<template>
  <div class="px-10 py-10 flex flex-col justify-between items-center gap-10 2xl:px-28 2xl:flex-row 2xl:gap-0">
    <div class="2xl:w-1/3 flex flex-col gap-8 relative">
      ...
      <button class="btn w-fit px-10 rounded-2xl border-0 bg-success text-base-100 font-semibold">Learn more</button>
    </div>
    <div>
      <a href="https://www.youtube.com/watch?v=_kqIdjhzMD0">
        <img class="" :src="'img/class-1.png'" alt="" />
      </a>
    </div>
  </div>
</template>
